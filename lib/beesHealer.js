...
exports.asJSON = function(valueObject, phaseName, args, callback){
        ...
        var res = new OwM();
        res.public         = valueObject.public;
        res.secure         = valueObject.secure;
...
exports.jsonToNative = function(serialisedValues, result){
    ...
    for(var v in serialisedValues.public) {
        result.public[v] = serialisedValues.public[v];
    };

    for(var v in serialisedValues.secure) {
        result.secure[v] = serialisedValues.secure[v];
    };
